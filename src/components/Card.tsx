...
function Card({ file, ref }: CardProps) {

    return (
        <motion.div ref={ref} drag dragConstraints={ref} dragMomentum={false} whileDrag={{ cursor: "grabbing" }} whileTap={{ scale: 1.05 }} dragElastic={0} className={`relative flex-shrink-0 bg-zinc-800/90 backdrop-blur-sm overflow-hidden p-5 text-white rounded-[40px] w-64 h-72`}>
